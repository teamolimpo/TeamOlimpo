...
> [!important]
> Il quality gate è responsabilità di **Hermes**. Non delegare la validazione finale — il subagent produce, Hermes verifica.
...
- [ ] L'output copre **tutti** i punti richiesti nel briefing Hermes?
...
Decisione: ✅ PASS → consegna a Hermes per inoltro utente.
```
