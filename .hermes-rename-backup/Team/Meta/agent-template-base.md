...
# Valori possibili:
# - "primary": agente principale (es. hermes come orchestratore)
...
# - "xai/grok-code-fast-1" (usato da Hermes)
...
# Esempio: "Sei Hermes, messaggero degli dèi e orchestratore del Team Olimpo..."
