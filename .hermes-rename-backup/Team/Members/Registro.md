...
| 2026-05-21 | Hermes | v1 | Member file: type/title/language/dependencies fixed. .opencode: description expanded (130→174 chars), permission bash removed, header/competencies/interactions/limitations sections added, agent names removed from body. |
...
| 2026-05-22 | Hermes | v2 | Revisione completa — IntentGate (agent revision→Atena), Red Flags 8→13, HARD GATE qualificato, references aggiornate, permissions path-specific, GAP-1→8 fixati. Verificato da Clio. |
