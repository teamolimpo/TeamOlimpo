...
Storage location: ``lib/System/Hermes/session.db`` (relative to project root,
...
_DEFAULT_DB_REL = Path("lib/System/Hermes/session.db")
...
def _resolve_db_path() -> Path:
    ...
    2. Default: ``lib/System/Hermes/session.db`` relative to project root
