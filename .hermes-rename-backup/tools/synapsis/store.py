...
Storage location: ``lib/System/Hermes/synapsis.db`` (relative to project root,
...
_DEFAULT_DB_REL = Path("Library/System/Hermes/synapsis.db")
...
CREATE TABLE IF NOT EXISTS task_events (
    ...
    type            TEXT NOT NULL
                    CHECK (type IN (
                        'handoff_ref', 'note', 'decision',
                        'deviation', 'status_change', 'created'
                    )),
...
class SynapsisStore:
    ...
    def update_task_status(
        ...
        from tools.synapsis.models import StateMachine as SM
