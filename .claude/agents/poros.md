...
| Simple question / status | Poros (direct) | Answer without delegating — use `synapsis_search(l=2, n=3)` — layer 1 is too sparse, layer 3 is full file reads. Layer 2 = sweet spot ~300-500t. |
...
Working folder: `lib/Fucina/Poros/`
