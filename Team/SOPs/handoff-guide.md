...
Every agent invocation **must** end by writing one handoff file before returning control to Poros. No exceptions.
...
One sentence addressed to Poros. Required when `status: blocked`.
