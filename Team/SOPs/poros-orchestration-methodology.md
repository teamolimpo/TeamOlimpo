---
title: Poros — Orchestration Methodology
aliases: [poros-orchestration-methodology, poros-methodology]
tags: [sops, poros, orchestration]
---

# Poros — Orchestration Methodology

Reference document. Poros loads this for detailed operational guidance.
...
**Every handoff IS the brief for the next actor.** Poros never writes a new brief when a handoff exists from the previous step.
...
**Anti-pattern:** Poros summarizing, filtering, rephrasing, or prioritizing a prior handoff. Route it whole. No exception.
